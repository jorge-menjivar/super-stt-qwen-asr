...
stage *args: (build-release args)
    cp target/release/super-stt-backend-qwen-asr super-stt-backend-qwen-asr
    @echo "staged super-stt-backend-qwen-asr — this directory is now installable with Import from dir"
...
clean-all: clean
    rm -f super-stt-backend-qwen-asr lcov.info *.profraw *.profdata
